...
class RPPParser:
    ...
    def copy_track_settings(self, source_track: TrackInfo, target_track: TrackInfo, 
        ...
        if target_track.is_master:
            self._copy_master_track_settings(source_track, target_track, copy_volume, copy_pan, copy_effects)
        elif source_track.is_master:
            # Can't copy from master to regular track directly, but we can copy some settings
            self._copy_from_master_to_track(source_track, target_track, copy_volume, copy_pan, copy_effects)
        else:
            # Regular track to track copy
            self._copy_regular_track_settings(source_track, target_track, copy_volume, copy_pan, copy_effects)
    
    def _copy_master_track_settings(self, source_track: TrackInfo, target_track: TrackInfo,
                                   copy_volume=True, copy_pan=True, copy_effects=True):
    ...
    def _copy_from_master_to_track(self, source_track: TrackInfo, target_track: TrackInfo,
                                  copy_volume=True, copy_pan=True, copy_effects=True):
    ...
    def _copy_regular_track_settings(self, source_track: TrackInfo, target_track: TrackInfo,
                                    copy_volume=True, copy_pan=True, copy_effects=True):
