...
class TestTrackCopying:
    ...
    def test_copy_between_regular_tracks(self, temp_rpp_file):
        ...
        # Copy volume only
        parser2.copy_track_settings(track1, track2, copy_volume=True, copy_pan=False, copy_effects=False)
    ...
    def test_copy_master_to_regular(self, temp_rpp_file):
        ...
        original_effects = len(regular.effects)
        master_effects = len(master.effects)
        
        # Copy effects from master to regular track
        parser2.copy_track_settings(master, regular, copy_effects=True, copy_volume=False, copy_pan=False)
    ...
    def test_copy_regular_to_master(self, temp_rpp_file):
        ...
        parser2.copy_track_settings(regular, master, copy_effects=True, copy_volume=False, copy_pan=False)
